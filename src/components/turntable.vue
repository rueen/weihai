<template>
  <div class="turntable">
    ...
    <div class="tips">
      <div class="p-1 f16">归集数量
        <div class="fr yellow"><span class="f24">{{total | NumFormat}}</span><span class="f24">条</span></div>
      </div>
      <div class="p-2 f16">法人归集数量
        <div class="fr yellow"><span class="f24">{{num1 | NumFormat}}</span><span class="f24">条</span></div>
      </div>
      <div class="p-3 f16">自然人归集数量
        <div class="fr red"><span class="f24">{{num2 | NumFormat}}</span><span class="f24">条</span></div>
      </div>
      <div class="p-4 f16">行政许可数量
        <div class="fr yellow"><span class="f24">{{num3 | NumFormat}}</span><span class="f24">条</span></div>
      </div>
      <div class="p-5 f16">行政处罚数量
        <div class="fr yellow"><span class="f24">{{num4 | NumFormat}}</span><span class="f24">条</span></div>
      </div>
