<template>
  <div class="layout">
    <div class="topBg">
      <h1 class="table">
        <div class="table-cell">威海市信用大数据分析平台</div>
      </h1>
    </div>
    <div class="goBck">
      ...
      <div class="left">
        <div class="searchBox searchBox1">
          ...
          <div class="inner">
            ...
            <p class="tips" v-if="resultList.length > 0">共找到{{total}}家匹配的企业，重新搜索请点击<span class="goBack"
                                                                                         @click="reSearch">返回</span>或直接在搜索框中输入企业、个人名称
            </p>
          </div>
